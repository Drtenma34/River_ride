...
<body class="corp">
    <h1>Groupe Japan Expo</h1>
    <img src="image anime/salon3.webp" alt="Japan Expo" style="width:350px;">

    <div id="messageContainer" class="message-container">

    <div class="message admin-message">
            <span class="user">Admin:</span>
            <span class="content">Bienvenue dans le forum de discussion Japan Expo !</span>
        </div>
            <div class="message">
...
<div>
    ...
    <div>
<img src="image anime/luffy.jpg" alt="Logo" style="width:550px; height:450px;">
<img src="image anime/expo.jpeg" alt="Logo" style="width:550px; height:450px;">
</div>
