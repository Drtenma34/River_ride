...
<input type="pseudo" name="pseudo" class="form-control mt-6 mb-3 " placeholder="Choisissez un pseudo" value="<?= (isset($_COOKIE['pseudo']) ? $_COOKIE['pseudo'] : '') ?>">
    ...
    <p> Compte existant? <strong><a href="connexion.php"> Se connecter</a></strong></p>
