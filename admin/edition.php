...
<form method="POST"  action="verif_anime.php" enctype="multipart/form-data" >

  <label for="-">Saison :</label><br>
  <input type="text" id="saison" name="saison" size="50"><br>
  <label for="annee">Année :</label><br>
<input type="number" id="annee" name="annee" min="1900" max="<?php echo date('Y'); ?>" step="1"><br>
  <label for="-">Synopsis :</label><br>
  <input type="text" id="synopsis" name="synopsis" size="50"><br>
  <label for="image">Poster :</label><br>
<input type="file" id="image" name="image" accept="image/jpg"><br>
